...
#define PA2__Set_0 GPIOA->ODR &= 0xFFFC
#define PA3__Set_0 GPIOA->ODR &= 0xFFFB
#define PA4__Set_0 GPIOA->ODR &= 0xFFEF
#define PA5__Set_0 GPIOA->ODR &= 0xFFDF
#define PA6__Set_0 GPIOA->ODR &= 0xFFCF
#define PA7__Set_0 GPIOA->ODR &= 0xFFBF
#define PA8__Set_0 GPIOA->ODR &= 0xFEFF
#define PA9__Set_0 GPIOA->ODR &= 0xFDFF
#define PA10_Set_0 GPIOA->ODR &= 0xFCFF
#define PA11_Set_0 GPIOA->ODR &= 0xFBFF
#define PA12_Set_0 GPIOA->ODR &= 0xEFFF
#define PA13_Set_0 GPIOA->ODR &= 0xDFFF
#define PA14_Set_0 GPIOA->ODR &= 0xCFFF
#define PA15_Set_0 GPIOA->ODR &= 0xBFFF

#define PB0__Set_0 GPIOB->ODR &= 0xFFFE
#define PB1__Set_0 GPIOB->ODR &= 0xFFFD
#define PB2__Set_0 GPIOB->ODR &= 0xFFFC
#define PB3__Set_0 GPIOB->ODR &= 0xFFFB
#define PB4__Set_0 GPIOB->ODR &= 0xFFEF
#define PB5__Set_0 GPIOB->ODR &= 0xFFDF
#define PB6__Set_0 GPIOB->ODR &= 0xFFCF
#define PB7__Set_0 GPIOB->ODR &= 0xFFBF
#define PB8__Set_0 GPIOB->ODR &= 0xFEFF
#define PB9__Set_0 GPIOB->ODR &= 0xFDFF
#define PB10_Set_0 GPIOB->ODR &= 0xFCFF
#define PB11_Set_0 GPIOB->ODR &= 0xFBFF
#define PB12_Set_0 GPIOB->ODR &= 0xEFFF
#define PB13_Set_0 GPIOB->ODR &= 0xDFFF
#define PB14_Set_0 GPIOB->ODR &= 0xCFFF
#define PB15_Set_0 GPIOB->ODR &= 0xBFFF

#define PC0__Set_0 GPIOC->ODR &= 0xFFFE
#define PC1__Set_0 GPIOC->ODR &= 0xFFFD
#define PC2__Set_0 GPIOC->ODR &= 0xFFFC
#define PC3__Set_0 GPIOC->ODR &= 0xFFFB
#define PC4__Set_0 GPIOC->ODR &= 0xFFEF
#define PC5__Set_0 GPIOC->ODR &= 0xFFDF
#define PC6__Set_0 GPIOC->ODR &= 0xFFCF
#define PC7__Set_0 GPIOC->ODR &= 0xFFBF
#define PC8__Set_0 GPIOC->ODR &= 0xFEFF
#define PC9__Set_0 GPIOC->ODR &= 0xFDFF
#define PC10_Set_0 GPIOC->ODR &= 0xFCFF
#define PC11_Set_0 GPIOC->ODR &= 0xFBFF
#define PC12_Set_0 GPIOC->ODR &= 0xEFFF
#define PC13_Set_0 GPIOC->ODR &= 0xDFFF
#define PC14_Set_0 GPIOC->ODR &= 0xCFFF
#define PC15_Set_0 GPIOC->ODR &= 0xBFFF

#define PD0__Set_0 GPIOD->ODR &= 0xFFFE
#define PD1__Set_0 GPIOD->ODR &= 0xFFFD
#define PD2__Set_0 GPIOD->ODR &= 0xFFFC
#define PD3__Set_0 GPIOD->ODR &= 0xFFFB
#define PD4__Set_0 GPIOD->ODR &= 0xFFEF
#define PD5__Set_0 GPIOD->ODR &= 0xFFDF
#define PD6__Set_0 GPIOD->ODR &= 0xFFCF
#define PD7__Set_0 GPIOD->ODR &= 0xFFBF
#define PD8__Set_0 GPIOD->ODR &= 0xFEFF
#define PD9__Set_0 GPIOD->ODR &= 0xFDFF
#define PD10_Set_0 GPIOD->ODR &= 0xFCFF
#define PD11_Set_0 GPIOD->ODR &= 0xFBFF
#define PD12_Set_0 GPIOD->ODR &= 0xEFFF
#define PD13_Set_0 GPIOD->ODR &= 0xDFFF
#define PD14_Set_0 GPIOD->ODR &= 0xCFFF
#define PD15_Set_0 GPIOD->ODR &= 0xBFFF

#define PE0__Set_0 GPIOE->ODR &= 0xFFFE
#define PE1__Set_0 GPIOE->ODR &= 0xFFFD
#define PE2__Set_0 GPIOE->ODR &= 0xFFFC
#define PE3__Set_0 GPIOE->ODR &= 0xFFFB
#define PE4__Set_0 GPIOE->ODR &= 0xFFEF
#define PE5__Set_0 GPIOE->ODR &= 0xFFDF
#define PE6__Set_0 GPIOE->ODR &= 0xFFCF
#define PE7__Set_0 GPIOE->ODR &= 0xFFBF
#define PE8__Set_0 GPIOE->ODR &= 0xFEFF
#define PE9__Set_0 GPIOE->ODR &= 0xFDFF
#define PE10_Set_0 GPIOE->ODR &= 0xFCFF
#define PE11_Set_0 GPIOE->ODR &= 0xFBFF
#define PE12_Set_0 GPIOE->ODR &= 0xEFFF
#define PE13_Set_0 GPIOE->ODR &= 0xDFFF
#define PE14_Set_0 GPIOE->ODR &= 0xCFFF
#define PE15_Set_0 GPIOE->ODR &= 0xBFFF

#define PF0__Set_0 GPIOF->ODR &= 0xFFFE
#define PF1__Set_0 GPIOF->ODR &= 0xFFFD
#define PF2__Set_0 GPIOF->ODR &= 0xFFFC
#define PF3__Set_0 GPIOF->ODR &= 0xFFFB
#define PF4__Set_0 GPIOF->ODR &= 0xFFEF
#define PF5__Set_0 GPIOF->ODR &= 0xFFDF
#define PF6__Set_0 GPIOF->ODR &= 0xFFCF
#define PF7__Set_0 GPIOF->ODR &= 0xFFBF
#define PF8__Set_0 GPIOF->ODR &= 0xFEFF
#define PF9__Set_0 GPIOF->ODR &= 0xFDFF
#define PF10_Set_0 GPIOF->ODR &= 0xFCFF
#define PF11_Set_0 GPIOF->ODR &= 0xFBFF
#define PF12_Set_0 GPIOF->ODR &= 0xEFFF
#define PF13_Set_0 GPIOF->ODR &= 0xDFFF
#define PF14_Set_0 GPIOF->ODR &= 0xCFFF
#define PF15_Set_0 GPIOF->ODR &= 0xBFFF

#define PG0__Set_0 GPIOG->ODR &= 0xFFFE
#define PG1__Set_0 GPIOG->ODR &= 0xFFFD
#define PG2__Set_0 GPIOG->ODR &= 0xFFFC
#define PG3__Set_0 GPIOG->ODR &= 0xFFFB
#define PG4__Set_0 GPIOG->ODR &= 0xFFEF
#define PG5__Set_0 GPIOG->ODR &= 0xFFDF
#define PG6__Set_0 GPIOG->ODR &= 0xFFCF
#define PG7__Set_0 GPIOG->ODR &= 0xFFBF
#define PG8__Set_0 GPIOG->ODR &= 0xFEFF
#define PG9__Set_0 GPIOG->ODR &= 0xFDFF
#define PG10_Set_0 GPIOG->ODR &= 0xFCFF
#define PG11_Set_0 GPIOG->ODR &= 0xFBFF
#define PG12_Set_0 GPIOG->ODR &= 0xEFFF
#define PG13_Set_0 GPIOG->ODR &= 0xDFFF
#define PG14_Set_0 GPIOG->ODR &= 0xCFFF
#define PG15_Set_0 GPIOG->ODR &= 0xBFFF
